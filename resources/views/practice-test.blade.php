            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid gap-10 lg:grid-cols-2 lg:gap-12 lg:items-start">
                    <div>
                        ...
                        <ul class="mt-6 space-y-3 text-lg leading-8 text-slate-700 text-justify">
                            <li class="flex gap-3">
                                <span class="mt-2 h-2 w-2 shrink-0 rounded-full bg-logo-light-green" aria-hidden="true"></span>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-5 shadow-sm">
                            <p class="text-lg font-semibold text-brand-900">Question Bank</p>
                            <p class="mt-2 text-lg text-slate-700 text-justify">Comprehensive topic coverage across essential nursing areas</p>
                        </div>
                        <div class="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-5 shadow-sm">
                            <p class="text-lg font-semibold text-brand-900">Clinical Scenarios</p>
                            <p class="mt-2 text-lg text-slate-700 text-justify">Case-based practice for decision-making and application of knowledge</p>
                        </div>
                        <div class="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-5 shadow-sm">
                            <p class="text-lg font-semibold text-brand-900">Instant Feedback</p>
                            <p class="mt-2 text-lg text-slate-700 text-justify">Immediate explanations and rationales for better learning</p>
                        </div>
                        <div class="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-5 shadow-sm">
                            <p class="text-lg font-semibold text-brand-900">Flexible Access</p>
                            <p class="mt-2 text-lg text-slate-700 text-justify">Practice anytime online at your own convenience</p>
                        </div>
                        <div class="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-5 shadow-sm sm:col-span-2">
                            <p class="text-lg font-semibold text-brand-900">Purpose</p>
                            <p class="mt-2 text-lg text-slate-700 text-justify">Regular self-assessment helps nurses maintain high standards of care and achieve professional excellence.</p>
                        </div>
                    </div>
                </div>
