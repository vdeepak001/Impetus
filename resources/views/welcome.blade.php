...
<body class="antialiased bg-slate-50 text-slate-800">
    ...
    <header x-data="{ mobileMenuOpen: false, scrolled: true }" 
            ...
            class="fixed top-4 inset-x-4 z-50 max-w-7xl mx-auto rounded-full bg-white/70 backdrop-blur-xl border border-slate-200/50 shadow-2xl py-3 px-6 transition-all duration-500">
