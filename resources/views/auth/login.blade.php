...
@section('content')
    <div class="relative min-h-screen overflow-hidden bg-white dark:bg-gray-950">
        <div class="relative flex min-h-screen w-full flex-col lg:flex-row">
            <div
                class="flex w-full flex-1 items-center justify-center p-6 sm:p-10 lg:w-1/2 lg:bg-[#f8fafc] dark:lg:bg-gray-950">
                <div
                    class="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-xl sm:p-10 dark:border-gray-800 dark:bg-gray-900">
                    <div>
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        ...
                                        @if (Route::has('password.request'))
                                            <a href="{{ route('password.request') }}"
                                                class="text-brand-500 hover:text-brand-600 text-sm font-semibold transition dark:text-brand-400">
                                                Forgot password?
                                            </a>
                                        @endif
                                    </div>
            ...
            <div
                class="relative hidden w-full items-center justify-center bg-gradient-to-br from-[#0b1430] via-[#111b3a] to-[#1d3a77] px-8 py-12 lg:flex lg:min-h-screen lg:w-1/2">
                <div class="absolute inset-0 opacity-30">
                    <div
                        class="h-full w-full bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.18),transparent_42%),radial-gradient(circle_at_70%_80%,rgba(56,189,248,0.18),transparent_40%)]">
                    </div>
                </div>
                <div
                    class="relative z-10 mx-auto w-full max-w-md rounded-3xl border border-white/10 bg-white/8 p-10 shadow-2xl backdrop-blur-lg">
                    <div
                        class="mx-auto mb-6 flex h-20 w-56 items-center justify-center rounded-2xl bg-white/95 p-3 shadow-lg">
                    ...
                    <p class="mx-auto mb-6 max-w-sm text-center text-sm leading-6 text-slate-200">
                        Empowering healthcare professionals through engaging courses, exam preparation, and interactive
                        training.
                    </p>
