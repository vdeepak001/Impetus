...
@section('content')
    ...
    <div class="flex flex-wrap items-center gap-x-6 gap-y-3 mb-6 px-1">
        <div
            ...
            <span
                class="flex h-6 w-6 items-center justify-center rounded-full bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400 font-black">S</span>
            Success
        </div>
        <div
            class="flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
            <span
                class="flex h-6 w-6 items-center justify-center rounded-full bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400 font-black">F</span>
            Failed
        </div>
        <div
            class="flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
            <span
                class="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 font-black">I</span>
            Initiated
        </div>
        <div
            class="flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
            <span
                class="flex h-6 w-6 items-center justify-center rounded-full bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400 font-black">A</span>
            Aborted
        </div>
    </div>
                ...
                <thead>
                    <tr class="bg-[#0082c8]">
                        ...
                        <th
                            ...
                            Time of purchase</th>
                        <th
                            class="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider border-b border-blue-400/20 text-center">
                            Status</th>
                    </tr>
                </thead>
