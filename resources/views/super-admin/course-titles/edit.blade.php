            ...
            <form method="POST" action="{{ route('course-titles.update', $courseTitle) }}">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <select id="course_id" name="course_id" required
                            ...
                            @foreach($courses as $course)
                                <option value="{{ $course->id }}" {{ old('course_id', $courseTitle->course_id) == $course->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input id="title_name" type="text" name="title_name" value="{{ old('title_name', $courseTitle->title_name) }}" required
                    ...
                    <div>
                        ...
                        <textarea id="title_description" name="title_description" rows="3"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">{{ old('title_description', $courseTitle->title_description) }}</textarea>
